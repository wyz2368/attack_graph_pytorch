...
def act_att(observation, mask, training_attacker, stochastic=True, update_eps=-1, *args, **kwargs):
...
def act_def(observation, mask, training_attacker, stochastic=True, update_eps=-1, *args, **kwargs):
